               ...
               <div class="ibox-body">
                  ...
                  <table class="table table-striped m-t-20 visitors-table">
                     ...
                     <tbody>
                        <tr>
                           <td>
                              <img class="m-r-10" src="{{ asset('/admin/assets') }}/img/flags/us.png" />USA
                           </td>
                           <td>755</td>
                           <td>
                              <div class="progress">
                        ...
                        <tr>
                           <td>
                              <img class="m-r-10" src="{{ asset('/admin/assets') }}/img/flags/Canada.png" />Canada
                           </td>
                           <td>700</td>
                           <td>
                              <div class="progress">
                        ...
                        <tr>
                           <td>
                              <img class="m-r-10" src="{{ asset('/admin/assets') }}/img/flags/India.png" />India
                           </td>
                           <td>410</td>
                           <td>
                              <div class="progress">
                        ...
                        <tr>
                           <td>
                              <img class="m-r-10" src="{{ asset('/admin/assets') }}/img/flags/Australia.png" />Australia
                           </td>
                           <td>304</td>
                           <td>
                              <div class="progress">
                        ...
                        <tr>
                           <td>
                              <img class="m-r-10" src="{{ asset('/admin/assets') }}/img/flags/Singapore.png" />Singapore
                           </td>
                           <td>203</td>
                           <td>
                              <div class="progress">
                                 <div class="progress-bar progress-bar" role="progressbar" style="width:35%; height:5px;"
                        ...
                        <tr>
                           <td>
                              <img class="m-r-10" src="{{ asset('/admin/assets') }}/img/flags/uk.png" />UK
                           </td>
                           <td>202</td>
                           <td>
                              <div class="progress">
                        ...
                        <tr>
                           <td>
                              <img class="m-r-10" src="{{ asset('/admin/assets') }}/img/flags/UAE.png" />UAE
                           </td>
                           <td>180</td>
                           <td>
                              <div class="progress">
               ...
               <div class="ibox-body">
                  <ul class="media-list media-list-divider m-0">
                     ...
                     <li class="media">
                        ...
                        <div class="media-body">
                           <div class="media-heading">Connor Perez <small class="float-right text-muted">Today</small>
                           </div>
                           <div class="font-13">Lorem Ipsum is simply dummy text of the printing and typesetting.
                           </div>
                        </div>
      ...
      <div>
         <a class="adminca-banner" href="http://admincast.com/adminca/" target="_blank">
            ...
            <div class="wrap-1">
               <div class="wrap-2">
                  <div>
                     <img src="{{ asset('/admin/assets') }}/img/adminca-banner/adminca-preview.jpg"
               ...
               <div style="flex:1;">
                  <div class="d-flex justify-content-end wrap-3">
                     <div class="adminca-banner-b m-r-20">
                        <img src="{{ asset('/admin/assets') }}/img/adminca-banner/bootstrap.png"
                           style="width:40px;margin-right:10px;" />Bootstrap v4
                     </div>
                     <div class="adminca-banner-b m-r-10">
                        <img src="{{ asset('/admin/assets') }}/img/adminca-banner/angular.png"
