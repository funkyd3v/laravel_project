               ...
               <form action="{{ route('add-to-cart') }}" method="post" id="cartForm">
                  ...
                  <div class="product-details-action-wrap">
                     ...
                     <div class="single-product-cart btn-hover">
                        <a href="#" id="cartSubmit" onclick="event.preventDefault(); document.getElementById('cartForm').submit()">Add to cart</a>
                     </div>
               ...
               <div class="single-review">
                  ...
                  <div class="review-content">
                     ...
                     <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a.
                        Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis
                        pharetra, in vehicula lacus scelerisque</p>
                  </div>
               </div>
            </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12">
                           <div class="save-email-option">
                              <p><input type="checkbox"> <label>Save my name, email, and website in this browser
