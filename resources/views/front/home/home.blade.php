                     ...
                     <div class="col-lg-6 col-md-6">
                        <div class="slider-content-1 slider-animated-1">
                           ...
                           <div class="slider-btn btn-hover">
                              <a href="{{ route('product-details', ['id' => 1]) }}" class="btn animated">
      ...
      <div class="row">
         <div class="col-lg-4 col-md-6 col-12">
            <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
               <a href="{{ route('product-details', ['id' => 1]) }}"><img
                     src="{{ asset ('/') }}assets/images/banner/banner-1.png" alt=""></a>
               <div class="banner-content-1">
                  <h5>new arrival</h5>
                  <h3>Office Chair</h3>
                  <div class="banner-btn">
                     <a href="{{ route('product-details', ['id' => 1]) }}">Shop Now</a>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                  <div class="product-img img-zoom mb-25">
                     ...
                     <div class="product-action-wrap">
                        ...
                        <button class="product-action-btn-1 showModal" data-id={{ $product->id }} title="Quick View"
                     ...
                     <div class="product-action-2-wrap">
                        <button class="product-action-btn-2 addToCart" data-id={{ $product->id }} data-qty="1" title="Add To Cart"><i
                              class="pe-7s-cart"></i> Add to
                           cart</button>
                     </div>
                  </div>
            ...
            <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
               ...
               <div class="banner-content-2">
                  ...
                  <div class="btn-style-2 btn-hover">
                     <a href="{{ route('product-details', ['id' => 1]) }}" class="btn">
                        Shop Now
                     </a>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div class="col-lg-6 col-md-6">
            <div class="home-single-product-content">
               ...
               <p data-aos="fade-up" data-aos-delay="600">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                  do eiusmod tempo incididunt ut labore et dolore mt aliqua. Ut enim ad minim veniam, quis nostrud
            ...
            <div class="row">
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="200">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">Interior moderno render</a></h3>
                        <div class="product-price">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">Stylish Dining Chair</a></h3>
                        <div class="product-price">
                           <span>$50.25 </span>
                        </div>
                     </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="600">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">Round Standard Chair</a></h3>
                        <div class="product-price">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="800">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">Stylish Swing Chair</a></h3>
                        <div class="product-price">
                           <span>$30.25 </span>
                        </div>
                     </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="200">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">Modern Swivel Chair</a></h3>
                        <div class="product-price">
                           <span class="old-price">$25.89 </span>
                           <span class="new-price">$20.25 </span>
                        </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">New Modern Sofa Set</a></h3>
                        <div class="product-price">
                           <span>$50.25 </span>
                        </div>
                     </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="600">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">Easy Modern Chair</a></h3>
                        <div class="product-price">
                           <span class="old-price">$45.00 </span>
                           <span class="new-price">$40.00 </span>
                        </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="800">
                     ...
                     <div class="product-content">
                        <h3><a href="{{ route('product-details', ['id' => 1]) }}">Modern Lounge Chairs</a></h3>
                        <div class="product-price">
                           <span>$30.25 </span>
                        </div>
                     </div>
